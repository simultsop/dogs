        ...
        <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
            <div>
                <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                    ...
                    <a v-for="n in maxPage" :key="'page'+n" href="#" aria-current="page"
                        class="relative z-10 inline-flex items-center border border-indigo-500 bg-indigo-50 px-4 py-2 text-sm font-medium text-indigo-600 focus:z-20">{{n}}</a>
                    <a href="#"
...
<script setup>
const currentPage = useState('current-page', () => 1)
const maxPage = 10;
